...
class AutoKeyBroadcaster:
    def __init__(self, root):
        ...
        self.root.minsize(535, 550)
        self.root.maxsize(535, 960)
    ...
    def create_widgets(self):
        ...
        self.loop_delay_label = Label(
            loop_settings_frame, text="Loop Delay (ms):", font=("TkDefaultFont", 8)
        )
        ...
        self.loop_randomize_label = Label(
            loop_settings_frame, text="± Random (ms):", font=("TkDefaultFont", 8)
        )
        ...
        self.rr_status_label = Label(
            rr_info_frame, text="Current target: None", font=("TkDefaultFont", 8)
        )
